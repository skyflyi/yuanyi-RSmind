...
def train():
    """train"""
    args = parse_args()
    mindspore.set_context(mode=0, save_graphs=False, device_target=args.device_target)
    ...
    if args.modelArts_mode:
        ...
        if device_num > 1:
            ...
            mindspore.set_auto_parallel_context(parallel_mode=parallel_mode, gradients_mean=True,
