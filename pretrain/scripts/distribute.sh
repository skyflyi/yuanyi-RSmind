#!/bin/bash
# ulimit -u unlimited
# bash /home/hw/shijie/MAE_BYOL/code/pretrain/scripts/distribute.sh /home/hw/shijie/MAE_BYOL/pretrain_out
get_real_path(){
    if [ "${1:0:1}" == "/" ]; then
        echo "$1"
    else
...
do  
    ...
    env > env.log
    python3 ./pretrain/train_offline.py >${RANK_ID}.log 2>&1 &
done
